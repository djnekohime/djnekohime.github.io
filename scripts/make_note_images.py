...
EYEBROW_PINK = "「解決編」"
EYECATCH_TITLE = ["動物病院を６件使い分けて", "猫の血尿をなおした話"]
EYECATCH_SUB = ["あきらめない人の", "病院の使い分け６つ"]

# 解決策まとめカード ＋ リールのテロップ（共通で使う）
CARD_EYEBROW = "うちの動物病院の使い分け"
SOLUTIONS = [
    "ふだん使い：会計が安くて明朗。ワクチンなどはここ",
    "近所の年配の先生の病院。カード不可、でも融通きく",
    "無理を聞いてくれる、避妊去勢の安い病院",
    "保護猫・里親活動に力を入れてる、避妊去勢の安い病院",
    "ヘルニア専門のダックス病院",
    "心臓の専門医",
]
...
REEL_EYEBROW = "解決編リール"
REEL_HOOK = ["猫が血尿。でも", "あきらめずになおした"]
REEL_HOOK_SUB = "動物病院、６件使い分けてます"
REEL_PROGRESS_LABEL = "うちの動物病院の使い分け６つ"
REEL_CLOSE = ["運がいいんじゃない。", "あきらめずに", "方法を探し続けただけ"]
