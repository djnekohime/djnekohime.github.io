...
EYEBROW_PINK = "「解決編」"
EYECATCH_TITLE = ["カラータイマーついても", "新企画に飛びつく話"]
EYECATCH_SUB = ["新企画に振り回されない", "ための7つの方法"]

# 解決策まとめカード ＋ リールのテロップ（共通で使う）
CARD_EYEBROW = "新企画との付き合い方"
SOLUTIONS = [
    "思いついてもアイデア置き場に1行だけメモして寝かせる",
    "始める前に今日の1位タスクが終わってるか自分に聞く",
    "大事じゃない・飽きた・やりたくないのどれか自問する",
    "新しい企画は今日中には始めないルールにする",
    "可処分時間時計に新企画用の枠をあらかじめ作っておく",
    "タスクをやめる時はやめる理由を1行だけ書く",
    "飛びついても元のタスクは消さず保留として残す",
]

# Instagram 解決編リール（9:16）
REEL_EYEBROW = "解決編リール"
REEL_HOOK = ["24時間時計で", "見える化したのに", "新企画に飛びついた"]
REEL_HOOK_SUB = "カラータイマーついても効かなかった"
REEL_PROGRESS_LABEL = "新企画に振り回されない7つの方法"
REEL_CLOSE = ["仕組みが負けたんやなく、", "新しさの魅力が", "強すぎるだけ"]
