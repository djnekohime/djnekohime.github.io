...
EYEBROW_PINK = "「解決編」"
EYECATCH_TITLE = ["停電３日放置しても", "メダカ全員ぴんぴんしてた話"]
EYECATCH_SUB = ["メダカを弱らせないために", "本当に大事な7つのこと"]

# 解決策まとめカード ＋ リールのテロップ（共通で使う）
CARD_EYEBROW = "メダカが本当に弱る条件"
SOLUTIONS = [
    "水槽が立ち上がってる（バクテリアが定着してる）かどうかが一番効く",
    "水量が多いほど、水質も水温も急には変わらない",
    "メダカは酸素が薄くても粘り強い魚（金魚や熱帯魚より丈夫）",
    "水草があると、日中はわずかに酸素を作ってくれる",
    "極端な過密飼育じゃなければ数日の停電では致命傷になりにくい",
    "フィルターは主に「ろ過」担当で、酸素は水面からのほうが大きい",
    "一番怖いのは停電より、慌てて薬や新しい機材を足すこと",
]

# Instagram 解決編リール（9:16）
REEL_EYEBROW = "解決編リール"
REEL_HOOK = ["停電３日放置したのに", "メダカが全員無事だった"]
REEL_HOOK_SUB = "フィルターも薬も、意味あったんか説"
REEL_PROGRESS_LABEL = "メダカを弱らせないために大事な7つのこと"
REEL_CLOSE = ["対策してた自分より、", "何もしてないメダカの方が", "強かっただけ"]
